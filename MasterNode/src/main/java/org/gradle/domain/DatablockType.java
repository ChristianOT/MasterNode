...
public class DatablockType {
    ...
    @Lob protected AtomSiteType atomSiteCategory;
    @XmlElement(name = "atom_site_anisotropCategory")
    @Lob protected AtomSiteAnisotropType atomSiteAnisotropCategory;
    @XmlElement(name = "atom_sitesCategory")
    @Lob protected AtomSitesType atomSitesCategory;
    @XmlElement(name = "atom_sites_altCategory")
    @Lob protected AtomSitesAltType atomSitesAltCategory;
    @XmlElement(name = "atom_sites_alt_ensCategory")
    @Lob protected AtomSitesAltEnsType atomSitesAltEnsCategory;
    @XmlElement(name = "atom_sites_alt_genCategory")
    @Lob protected AtomSitesAltGenType atomSitesAltGenCategory;
    @XmlElement(name = "atom_sites_footnoteCategory")
    @Lob protected AtomSitesFootnoteType atomSitesFootnoteCategory;
    @XmlElement(name = "atom_typeCategory")
    @Lob protected AtomTypeType atomTypeCategory;
    @Lob protected AuditType auditCategory;
    @XmlElement(name = "audit_authorCategory")
    @Lob protected AuditAuthorType auditAuthorCategory;
    @XmlElement(name = "audit_conformCategory")
    @Lob protected AuditConformType auditConformCategory;
    @XmlElement(name = "audit_contact_authorCategory")
    @Lob protected AuditContactAuthorType auditContactAuthorCategory;
    @XmlElement(name = "audit_linkCategory")
    @Lob protected AuditLinkType auditLinkCategory;
    @Lob protected CellType cellCategory;
    @XmlElement(name = "cell_measurementCategory")
    @Lob protected CellMeasurementType cellMeasurementCategory;
    @XmlElement(name = "cell_measurement_reflnCategory")
    @Lob protected CellMeasurementReflnType cellMeasurementReflnCategory;
    @XmlElement(name = "chem_compCategory")
    @Lob protected ChemCompType chemCompCategory;
    @XmlElement(name = "chem_comp_angleCategory")
    @Lob protected ChemCompAngleType chemCompAngleCategory;
    @XmlElement(name = "chem_comp_atomCategory")
    @Lob protected ChemCompAtomType chemCompAtomCategory;
    @XmlElement(name = "chem_comp_bondCategory")
    @Lob protected ChemCompBondType chemCompBondCategory;
    @XmlElement(name = "chem_comp_chirCategory")
    @Lob protected ChemCompChirType chemCompChirCategory;
    @XmlElement(name = "chem_comp_chir_atomCategory")
    @Lob protected ChemCompChirAtomType chemCompChirAtomCategory;
    @XmlElement(name = "chem_comp_linkCategory")
    @Lob protected ChemCompLinkType chemCompLinkCategory;
    @XmlElement(name = "chem_comp_planeCategory")
    @Lob protected ChemCompPlaneType chemCompPlaneCategory;
    @XmlElement(name = "chem_comp_plane_atomCategory")
    @Lob protected ChemCompPlaneAtomType chemCompPlaneAtomCategory;
    @XmlElement(name = "chem_comp_torCategory")
    @Lob protected ChemCompTorType chemCompTorCategory;
    @XmlElement(name = "chem_comp_tor_valueCategory")
    @Lob protected ChemCompTorValueType chemCompTorValueCategory;
    @XmlElement(name = "chem_linkCategory")
    @Lob protected ChemLinkType chemLinkCategory;
    @XmlElement(name = "chem_link_angleCategory")
    @Lob protected ChemLinkAngleType chemLinkAngleCategory;
    @XmlElement(name = "chem_link_bondCategory")
    @Lob protected ChemLinkBondType chemLinkBondCategory;
    @XmlElement(name = "chem_link_chirCategory")
    @Lob protected ChemLinkChirType chemLinkChirCategory;
    @XmlElement(name = "chem_link_chir_atomCategory")
    @Lob protected ChemLinkChirAtomType chemLinkChirAtomCategory;
    @XmlElement(name = "chem_link_planeCategory")
    @Lob protected ChemLinkPlaneType chemLinkPlaneCategory;
    @XmlElement(name = "chem_link_plane_atomCategory")
    @Lob protected ChemLinkPlaneAtomType chemLinkPlaneAtomCategory;
    @XmlElement(name = "chem_link_torCategory")
    @Lob protected ChemLinkTorType chemLinkTorCategory;
    @XmlElement(name = "chem_link_tor_valueCategory")
    @Lob protected ChemLinkTorValueType chemLinkTorValueCategory;
    @Lob protected ChemicalType chemicalCategory;
    @XmlElement(name = "chemical_conn_atomCategory")
    @Lob protected ChemicalConnAtomType chemicalConnAtomCategory;
    @XmlElement(name = "chemical_conn_bondCategory")
    @Lob protected ChemicalConnBondType chemicalConnBondCategory;
    @XmlElement(name = "chemical_formulaCategory")
    @Lob protected ChemicalFormulaType chemicalFormulaCategory;
    @Lob protected CitationType citationCategory;
    @XmlElement(name = "citation_authorCategory")
    @Lob protected CitationAuthorType citationAuthorCategory;
    @XmlElement(name = "citation_editorCategory")
    @Lob protected CitationEditorType citationEditorCategory;
    @Lob protected ComputingType computingCategory;
    @Lob protected DatabaseType databaseCategory;
    @XmlElement(name = "database_2Category")
    @Lob protected Database2Type database2Category;
    @XmlElement(name = "database_PDB_caveatCategory")
    @Lob protected DatabasePDBCaveatType databasePDBCaveatCategory;
    @XmlElement(name = "database_PDB_matrixCategory")
    @Lob protected DatabasePDBMatrixType databasePDBMatrixCategory;
    @XmlElement(name = "database_PDB_remarkCategory")
    @Lob protected DatabasePDBRemarkType databasePDBRemarkCategory;
    @XmlElement(name = "database_PDB_revCategory")
    @Lob protected DatabasePDBRevType databasePDBRevCategory;
    @XmlElement(name = "database_PDB_rev_recordCategory")
    @Lob protected DatabasePDBRevRecordType databasePDBRevRecordCategory;
    @XmlElement(name = "database_PDB_tvectCategory")
    @Lob protected DatabasePDBTvectType databasePDBTvectCategory;
    @Lob protected DiffrnType diffrnCategory;
    @XmlElement(name = "diffrn_attenuatorCategory")
    @Lob protected DiffrnAttenuatorType diffrnAttenuatorCategory;
    @XmlElement(name = "diffrn_detectorCategory")
    @Lob protected DiffrnDetectorType diffrnDetectorCategory;
    @XmlElement(name = "diffrn_measurementCategory")
    @Lob protected DiffrnMeasurementType diffrnMeasurementCategory;
    @XmlElement(name = "diffrn_orient_matrixCategory")
    @Lob protected DiffrnOrientMatrixType diffrnOrientMatrixCategory;
    @XmlElement(name = "diffrn_orient_reflnCategory")
    @Lob protected DiffrnOrientReflnType diffrnOrientReflnCategory;
    @XmlElement(name = "diffrn_radiationCategory")
    @Lob protected DiffrnRadiationType diffrnRadiationCategory;
    @XmlElement(name = "diffrn_radiation_wavelengthCategory")
    @Lob protected DiffrnRadiationWavelengthType diffrnRadiationWavelengthCategory;
    @XmlElement(name = "diffrn_reflnCategory")
    @Lob protected DiffrnReflnType diffrnReflnCategory;
    @XmlElement(name = "diffrn_reflnsCategory")
    @Lob protected DiffrnReflnsType diffrnReflnsCategory;
    @XmlElement(name = "diffrn_reflns_classCategory")
    @Lob protected DiffrnReflnsClassType diffrnReflnsClassCategory;
    @XmlElement(name = "diffrn_scale_groupCategory")
    @Lob protected DiffrnScaleGroupType diffrnScaleGroupCategory;
    @XmlElement(name = "diffrn_sourceCategory")
    @Lob protected DiffrnSourceType diffrnSourceCategory;
    @XmlElement(name = "diffrn_standard_reflnCategory")
    @Lob protected DiffrnStandardReflnType diffrnStandardReflnCategory;
    @XmlElement(name = "diffrn_standardsCategory")
    @Lob protected DiffrnStandardsType diffrnStandardsCategory;
    @XmlElement(name = "em_2d_crystal_entityCategory")
    @Lob protected Em2DCrystalEntityType em2DCrystalEntityCategory;
    @XmlElement(name = "em_2d_crystal_growCategory")
    @Lob protected Em2DCrystalGrowType em2DCrystalGrowCategory;
    @XmlElement(name = "em_2d_projection_selectionCategory")
    @Lob protected Em2DProjectionSelectionType em2DProjectionSelectionCategory;
    @XmlElement(name = "em_3d_fittingCategory")
    @Lob protected Em3DFittingType em3DFittingCategory;
    @XmlElement(name = "em_3d_fitting_listCategory")
    @Lob protected Em3DFittingListType em3DFittingListCategory;
    @XmlElement(name = "em_3d_reconstructionCategory")
    @Lob protected Em3DReconstructionType em3DReconstructionCategory;
    @XmlElement(name = "em_assemblyCategory")
    @Lob protected EmAssemblyType emAssemblyCategory;
    @XmlElement(name = "em_bufferCategory")
    @Lob protected EmBufferType emBufferCategory;
    @XmlElement(name = "em_buffer_componentsCategory")
    @Lob protected EmBufferComponentsType emBufferComponentsCategory;
    @XmlElement(name = "em_detectorCategory")
    @Lob protected EmDetectorType emDetectorCategory;
    @XmlElement(name = "em_electron_diffractionCategory")
    @Lob protected EmElectronDiffractionType emElectronDiffractionCategory;
    @XmlElement(name = "em_electron_diffraction_patternCategory")
    @Lob protected EmElectronDiffractionPatternType emElectronDiffractionPatternCategory;
    @XmlElement(name = "em_electron_diffraction_phaseCategory")
    @Lob protected EmElectronDiffractionPhaseType emElectronDiffractionPhaseCategory;
    @XmlElement(name = "em_entity_assemblyCategory")
    @Lob protected EmEntityAssemblyType emEntityAssemblyCategory;
    @XmlElement(name = "em_entity_assembly_listCategory")
    @Lob protected EmEntityAssemblyListType emEntityAssemblyListCategory;
    @XmlElement(name = "em_euler_angle_distributionCategory")
    @Lob protected EmEulerAngleDistributionType emEulerAngleDistributionCategory;
    @XmlElement(name = "em_experimentCategory")
    @Lob protected EmExperimentType emExperimentCategory;
    @XmlElement(name = "em_helical_entityCategory")
    @Lob protected EmHelicalEntityType emHelicalEntityCategory;
    @XmlElement(name = "em_icos_virus_shellsCategory")
    @Lob protected EmIcosVirusShellsType emIcosVirusShellsCategory;
    @XmlElement(name = "em_image_scansCategory")
    @Lob protected EmImageScansType emImageScansCategory;
    @XmlElement(name = "em_imagingCategory")
    @Lob protected EmImagingType emImagingCategory;
    @XmlElement(name = "em_sample_preparationCategory")
    @Lob protected EmSamplePreparationType emSamplePreparationCategory;
    @XmlElement(name = "em_sample_supportCategory")
    @Lob protected EmSampleSupportType emSampleSupportCategory;
    @XmlElement(name = "em_single_particle_entityCategory")
    @Lob protected EmSingleParticleEntityType emSingleParticleEntityCategory;
    @XmlElement(name = "em_virus_entityCategory")
    @Lob protected EmVirusEntityType emVirusEntityCategory;
    @XmlElement(name = "em_vitrificationCategory")
    @Lob protected EmVitrificationType emVitrificationCategory;
    @Lob protected EntityType entityCategory;
    @XmlElement(name = "entity_keywordsCategory")
    @Lob protected EntityKeywordsType entityKeywordsCategory;
    @XmlElement(name = "entity_linkCategory")
    @Lob protected EntityLinkType entityLinkCategory;
    @XmlElement(name = "entity_name_comCategory")
    @Lob protected EntityNameComType entityNameComCategory;
    @XmlElement(name = "entity_name_sysCategory")
    @Lob protected EntityNameSysType entityNameSysCategory;
    @XmlElement(name = "entity_polyCategory")
    @Lob protected EntityPolyType entityPolyCategory;
    @XmlElement(name = "entity_poly_seqCategory")
    @Lob protected EntityPolySeqType entityPolySeqCategory;
    @XmlElement(name = "entity_src_genCategory")
    @Lob protected EntitySrcGenType entitySrcGenCategory;
    @XmlElement(name = "entity_src_natCategory")
    @Lob protected EntitySrcNatType entitySrcNatCategory;
    @Lob protected EntryType entryCategory;
    @XmlElement(name = "entry_linkCategory")
    @Lob protected EntryLinkType entryLinkCategory;
    @Lob protected ExptlType exptlCategory;
    @XmlElement(name = "exptl_crystalCategory")
    @Lob protected ExptlCrystalType exptlCrystalCategory;
    @XmlElement(name = "exptl_crystal_faceCategory")
    @Lob protected ExptlCrystalFaceType exptlCrystalFaceCategory;
    @XmlElement(name = "exptl_crystal_growCategory")
    @Lob protected ExptlCrystalGrowType exptlCrystalGrowCategory;
    @XmlElement(name = "exptl_crystal_grow_compCategory")
    @Lob protected ExptlCrystalGrowCompType exptlCrystalGrowCompCategory;
    @Lob protected GeomType geomCategory;
    @XmlElement(name = "geom_angleCategory")
    @Lob protected GeomAngleType geomAngleCategory;
    @XmlElement(name = "geom_bondCategory")
    @Lob protected GeomBondType geomBondCategory;
    @XmlElement(name = "geom_contactCategory")
    @Lob protected GeomContactType geomContactCategory;
    @XmlElement(name = "geom_hbondCategory")
    @Lob protected GeomHbondType geomHbondCategory;
    @XmlElement(name = "geom_torsionCategory")
    @Lob protected GeomTorsionType geomTorsionCategory;
    @Lob protected JournalType journalCategory;
    @XmlElement(name = "journal_indexCategory")
    @Lob protected JournalIndexType journalIndexCategory;
    @XmlElement(name = "ndb_original_ndb_coordinatesCategory")
    @Lob protected NdbOriginalNdbCoordinatesType ndbOriginalNdbCoordinatesCategory;
    @XmlElement(name = "ndb_struct_conf_naCategory")
    @Lob protected NdbStructConfNaType ndbStructConfNaCategory;
    @XmlElement(name = "ndb_struct_feature_naCategory")
    @Lob protected NdbStructFeatureNaType ndbStructFeatureNaCategory;
    @XmlElement(name = "ndb_struct_na_base_pairCategory")
    @Lob protected NdbStructNaBasePairType ndbStructNaBasePairCategory;
    @XmlElement(name = "ndb_struct_na_base_pair_stepCategory")
    @Lob protected NdbStructNaBasePairStepType ndbStructNaBasePairStepCategory;
    @XmlElement(name = "pdbx_SG_projectCategory")
    @Lob protected PdbxSGProjectType pdbxSGProjectCategory;
    @XmlElement(name = "pdbx_atom_site_aniso_tlsCategory")
    @Lob protected PdbxAtomSiteAnisoTlsType pdbxAtomSiteAnisoTlsCategory;
    @XmlElement(name = "pdbx_auditCategory")
    @Lob protected PdbxAuditType pdbxAuditCategory;
    @XmlElement(name = "pdbx_audit_authorCategory")
    @Lob protected PdbxAuditAuthorType pdbxAuditAuthorCategory;
    @XmlElement(name = "pdbx_audit_supportCategory")
    @Lob protected PdbxAuditSupportType pdbxAuditSupportCategory;
    @XmlElement(name = "pdbx_bond_distance_limitsCategory")
    @Lob protected PdbxBondDistanceLimitsType pdbxBondDistanceLimitsCategory;
    @XmlElement(name = "pdbx_bufferCategory")
    @Lob protected PdbxBufferType pdbxBufferCategory;
    @XmlElement(name = "pdbx_buffer_componentsCategory")
    @Lob protected PdbxBufferComponentsType pdbxBufferComponentsCategory;
    @XmlElement(name = "pdbx_chem_comp_atom_editCategory")
    @Lob protected PdbxChemCompAtomEditType pdbxChemCompAtomEditCategory;
    @XmlElement(name = "pdbx_chem_comp_atom_featureCategory")
    @Lob protected PdbxChemCompAtomFeatureType pdbxChemCompAtomFeatureCategory;
    @XmlElement(name = "pdbx_chem_comp_auditCategory")
    @Lob protected PdbxChemCompAuditType pdbxChemCompAuditCategory;
    @XmlElement(name = "pdbx_chem_comp_bond_editCategory")
    @Lob protected PdbxChemCompBondEditType pdbxChemCompBondEditCategory;
    @XmlElement(name = "pdbx_chem_comp_descriptorCategory")
    @Lob protected PdbxChemCompDescriptorType pdbxChemCompDescriptorCategory;
    @XmlElement(name = "pdbx_chem_comp_featureCategory")
    @Lob protected PdbxChemCompFeatureType pdbxChemCompFeatureCategory;
    @XmlElement(name = "pdbx_chem_comp_identifierCategory")
    @Lob protected PdbxChemCompIdentifierType pdbxChemCompIdentifierCategory;
    @XmlElement(name = "pdbx_chem_comp_importCategory")
    @Lob protected PdbxChemCompImportType pdbxChemCompImportCategory;
    @XmlElement(name = "pdbx_chem_comp_subcomponent_entity_listCategory")
    @Lob protected PdbxChemCompSubcomponentEntityListType pdbxChemCompSubcomponentEntityListCategory;
    @XmlElement(name = "pdbx_chem_comp_subcomponent_struct_connCategory")
    @Lob protected PdbxChemCompSubcomponentStructConnType pdbxChemCompSubcomponentStructConnCategory;
    @XmlElement(name = "pdbx_constructCategory")
    @Lob protected PdbxConstructType pdbxConstructCategory;
    @XmlElement(name = "pdbx_construct_featureCategory")
    @Lob protected PdbxConstructFeatureType pdbxConstructFeatureCategory;
    @XmlElement(name = "pdbx_contact_authorCategory")
    @Lob protected PdbxContactAuthorType pdbxContactAuthorCategory;
    @XmlElement(name = "pdbx_coordinate_modelCategory")
    @Lob protected PdbxCoordinateModelType pdbxCoordinateModelCategory;
    @XmlElement(name = "pdbx_database_PDB_obs_sprCategory")
    @Lob protected PdbxDatabasePDBObsSprType pdbxDatabasePDBObsSprCategory;
    @XmlElement(name = "pdbx_database_messageCategory")
    @Lob protected PdbxDatabaseMessageType pdbxDatabaseMessageCategory;
    @XmlElement(name = "pdbx_database_procCategory")
    @Lob protected PdbxDatabaseProcType pdbxDatabaseProcCategory;
    @XmlElement(name = "pdbx_database_relatedCategory")
    @Lob protected PdbxDatabaseRelatedType pdbxDatabaseRelatedCategory;
    @XmlElement(name = "pdbx_database_remarkCategory")
    @Lob protected PdbxDatabaseRemarkType pdbxDatabaseRemarkCategory;
    @XmlElement(name = "pdbx_database_statusCategory")
    @Lob protected PdbxDatabaseStatusType pdbxDatabaseStatusCategory;
    @XmlElement(name = "pdbx_diffrn_reflns_shellCategory")
    @Lob protected PdbxDiffrnReflnsShellType pdbxDiffrnReflnsShellCategory;
    @XmlElement(name = "pdbx_distant_solvent_atomsCategory")
    @Lob protected PdbxDistantSolventAtomsType pdbxDistantSolventAtomsCategory;
    @XmlElement(name = "pdbx_domainCategory")
    @Lob protected PdbxDomainType pdbxDomainCategory;
    @XmlElement(name = "pdbx_domain_rangeCategory")
    @Lob protected PdbxDomainRangeType pdbxDomainRangeCategory;
    @XmlElement(name = "pdbx_entity_assemblyCategory")
    @Lob protected PdbxEntityAssemblyType pdbxEntityAssemblyCategory;
    @XmlElement(name = "pdbx_entity_nameCategory")
    @Lob protected PdbxEntityNameType pdbxEntityNameCategory;
    @XmlElement(name = "pdbx_entity_nonpolyCategory")
    @Lob protected PdbxEntityNonpolyType pdbxEntityNonpolyCategory;
    @XmlElement(name = "pdbx_entity_prod_protocolCategory")
    @Lob protected PdbxEntityProdProtocolType pdbxEntityProdProtocolCategory;
    @XmlElement(name = "pdbx_entity_src_gen_characterCategory")
    @Lob protected PdbxEntitySrcGenCharacterType pdbxEntitySrcGenCharacterCategory;
    @XmlElement(name = "pdbx_entity_src_gen_chromCategory")
    @Lob protected PdbxEntitySrcGenChromType pdbxEntitySrcGenChromCategory;
    @XmlElement(name = "pdbx_entity_src_gen_cloneCategory")
    @Lob protected PdbxEntitySrcGenCloneType pdbxEntitySrcGenCloneCategory;
    @XmlElement(name = "pdbx_entity_src_gen_clone_ligationCategory")
    @Lob protected PdbxEntitySrcGenCloneLigationType pdbxEntitySrcGenCloneLigationCategory;
    @XmlElement(name = "pdbx_entity_src_gen_clone_recombinationCategory")
    @Lob protected PdbxEntitySrcGenCloneRecombinationType pdbxEntitySrcGenCloneRecombinationCategory;
    @XmlElement(name = "pdbx_entity_src_gen_expressCategory")
    @Lob protected PdbxEntitySrcGenExpressType pdbxEntitySrcGenExpressCategory;
    @XmlElement(name = "pdbx_entity_src_gen_express_timepointCategory")
    @Lob protected PdbxEntitySrcGenExpressTimepointType pdbxEntitySrcGenExpressTimepointCategory;
    @XmlElement(name = "pdbx_entity_src_gen_fractCategory")
    @Lob protected PdbxEntitySrcGenFractType pdbxEntitySrcGenFractCategory;
    @XmlElement(name = "pdbx_entity_src_gen_lysisCategory")
    @Lob protected PdbxEntitySrcGenLysisType pdbxEntitySrcGenLysisCategory;
    @XmlElement(name = "pdbx_entity_src_gen_prod_digestCategory")
    @Lob protected PdbxEntitySrcGenProdDigestType pdbxEntitySrcGenProdDigestCategory;
    @XmlElement(name = "pdbx_entity_src_gen_prod_otherCategory")
    @Lob protected PdbxEntitySrcGenProdOtherType pdbxEntitySrcGenProdOtherCategory;
    @XmlElement(name = "pdbx_entity_src_gen_prod_other_parameterCategory")
    @Lob protected PdbxEntitySrcGenProdOtherParameterType pdbxEntitySrcGenProdOtherParameterCategory;
    @XmlElement(name = "pdbx_entity_src_gen_prod_pcrCategory")
    @Lob protected PdbxEntitySrcGenProdPcrType pdbxEntitySrcGenProdPcrCategory;
    @XmlElement(name = "pdbx_entity_src_gen_proteolysisCategory")
    @Lob protected PdbxEntitySrcGenProteolysisType pdbxEntitySrcGenProteolysisCategory;
    @XmlElement(name = "pdbx_entity_src_gen_pureCategory")
    @Lob protected PdbxEntitySrcGenPureType pdbxEntitySrcGenPureCategory;
    @XmlElement(name = "pdbx_entity_src_gen_refoldCategory")
    @Lob protected PdbxEntitySrcGenRefoldType pdbxEntitySrcGenRefoldCategory;
    @XmlElement(name = "pdbx_entity_src_synCategory")
    @Lob protected PdbxEntitySrcSynType pdbxEntitySrcSynCategory;
    @XmlElement(name = "pdbx_entry_detailsCategory")
    @Lob protected PdbxEntryDetailsType pdbxEntryDetailsCategory;
    @XmlElement(name = "pdbx_exptl_crystal_cryo_treatmentCategory")
    @Lob protected PdbxExptlCrystalCryoTreatmentType pdbxExptlCrystalCryoTreatmentCategory;
    @XmlElement(name = "pdbx_exptl_crystal_grow_compCategory")
    @Lob protected PdbxExptlCrystalGrowCompType pdbxExptlCrystalGrowCompCategory;
    @XmlElement(name = "pdbx_exptl_crystal_grow_solCategory")
    @Lob protected PdbxExptlCrystalGrowSolType pdbxExptlCrystalGrowSolCategory;
    @XmlElement(name = "pdbx_exptl_pdCategory")
    @Lob protected PdbxExptlPdType pdbxExptlPdCategory;
    @XmlElement(name = "pdbx_family_group_indexCategory")
    @Lob protected PdbxFamilyGroupIndexType pdbxFamilyGroupIndexCategory;
    @XmlElement(name = "pdbx_family_prd_auditCategory")
    @Lob protected PdbxFamilyPrdAuditType pdbxFamilyPrdAuditCategory;
    @XmlElement(name = "pdbx_feature_assemblyCategory")
    @Lob protected PdbxFeatureAssemblyType pdbxFeatureAssemblyCategory;
    @XmlElement(name = "pdbx_feature_domainCategory")
    @Lob protected PdbxFeatureDomainType pdbxFeatureDomainCategory;
    @XmlElement(name = "pdbx_feature_entryCategory")
    @Lob protected PdbxFeatureEntryType pdbxFeatureEntryCategory;
    @XmlElement(name = "pdbx_feature_monomerCategory")
    @Lob protected PdbxFeatureMonomerType pdbxFeatureMonomerCategory;
    @XmlElement(name = "pdbx_feature_sequence_rangeCategory")
    @Lob protected PdbxFeatureSequenceRangeType pdbxFeatureSequenceRangeCategory;
    @XmlElement(name = "pdbx_helical_symmetryCategory")
    @Lob protected PdbxHelicalSymmetryType pdbxHelicalSymmetryCategory;
    @XmlElement(name = "pdbx_moleculeCategory")
    @Lob protected PdbxMoleculeType pdbxMoleculeCategory;
    @XmlElement(name = "pdbx_molecule_featuresCategory")
    @Lob protected PdbxMoleculeFeaturesType pdbxMoleculeFeaturesCategory;
    @XmlElement(name = "pdbx_nmr_assigned_chem_shift_listCategory")
    @Lob protected PdbxNmrAssignedChemShiftListType pdbxNmrAssignedChemShiftListCategory;
    @XmlElement(name = "pdbx_nmr_chem_shift_experimentCategory")
    @Lob protected PdbxNmrChemShiftExperimentType pdbxNmrChemShiftExperimentCategory;
    @XmlElement(name = "pdbx_nmr_chem_shift_refCategory")
    @Lob protected PdbxNmrChemShiftRefType pdbxNmrChemShiftRefCategory;
    @XmlElement(name = "pdbx_nmr_chem_shift_referenceCategory")
    @Lob protected PdbxNmrChemShiftReferenceType pdbxNmrChemShiftReferenceCategory;
    @XmlElement(name = "pdbx_nmr_chem_shift_softwareCategory")
    @Lob protected PdbxNmrChemShiftSoftwareType pdbxNmrChemShiftSoftwareCategory;
    @XmlElement(name = "pdbx_nmr_constraint_fileCategory")
    @Lob protected PdbxNmrConstraintFileType pdbxNmrConstraintFileCategory;
    @XmlElement(name = "pdbx_nmr_constraintsCategory")
    @Lob protected PdbxNmrConstraintsType pdbxNmrConstraintsCategory;
    @XmlElement(name = "pdbx_nmr_detailsCategory")
    @Lob protected PdbxNmrDetailsType pdbxNmrDetailsCategory;
    @XmlElement(name = "pdbx_nmr_ensembleCategory")
    @Lob protected PdbxNmrEnsembleType pdbxNmrEnsembleCategory;
    @XmlElement(name = "pdbx_nmr_ensemble_rmsCategory")
    @Lob protected PdbxNmrEnsembleRmsType pdbxNmrEnsembleRmsCategory;
    @XmlElement(name = "pdbx_nmr_exptlCategory")
    @Lob protected PdbxNmrExptlType pdbxNmrExptlCategory;
    @XmlElement(name = "pdbx_nmr_exptl_sampleCategory")
    @Lob protected PdbxNmrExptlSampleType pdbxNmrExptlSampleCategory;
    @XmlElement(name = "pdbx_nmr_exptl_sample_conditionsCategory")
    @Lob protected PdbxNmrExptlSampleConditionsType pdbxNmrExptlSampleConditionsCategory;
    @XmlElement(name = "pdbx_nmr_force_constantsCategory")
    @Lob protected PdbxNmrForceConstantsType pdbxNmrForceConstantsCategory;
    @XmlElement(name = "pdbx_nmr_refineCategory")
    @Lob protected PdbxNmrRefineType pdbxNmrRefineCategory;
    @XmlElement(name = "pdbx_nmr_representativeCategory")
    @Lob protected PdbxNmrRepresentativeType pdbxNmrRepresentativeCategory;
    @XmlElement(name = "pdbx_nmr_sample_detailsCategory")
    @Lob protected PdbxNmrSampleDetailsType pdbxNmrSampleDetailsCategory;
    @XmlElement(name = "pdbx_nmr_softwareCategory")
    @Lob protected PdbxNmrSoftwareType pdbxNmrSoftwareCategory;
    @XmlElement(name = "pdbx_nmr_software_taskCategory")
    @Lob protected PdbxNmrSoftwareTaskType pdbxNmrSoftwareTaskCategory;
    @XmlElement(name = "pdbx_nmr_spectral_dimCategory")
    @Lob protected PdbxNmrSpectralDimType pdbxNmrSpectralDimCategory;
    @XmlElement(name = "pdbx_nmr_spectral_peak_listCategory")
    @Lob protected PdbxNmrSpectralPeakListType pdbxNmrSpectralPeakListCategory;
    @XmlElement(name = "pdbx_nmr_spectral_peak_softwareCategory")
    @Lob protected PdbxNmrSpectralPeakSoftwareType pdbxNmrSpectralPeakSoftwareCategory;
    @XmlElement(name = "pdbx_nmr_spectrometerCategory")
    @Lob protected PdbxNmrSpectrometerType pdbxNmrSpectrometerCategory;
    @XmlElement(name = "pdbx_nmr_systematic_chem_shift_offsetCategory")
    @Lob protected PdbxNmrSystematicChemShiftOffsetType pdbxNmrSystematicChemShiftOffsetCategory;
    @XmlElement(name = "pdbx_nmr_uploadCategory")
    @Lob protected PdbxNmrUploadType pdbxNmrUploadCategory;
    @XmlElement(name = "pdbx_nonpoly_schemeCategory")
    @Lob protected PdbxNonpolySchemeType pdbxNonpolySchemeCategory;
    @XmlElement(name = "pdbx_phasing_MAD_setCategory")
    @Lob protected PdbxPhasingMADSetType pdbxPhasingMADSetCategory;
    @XmlElement(name = "pdbx_phasing_MAD_set_shellCategory")
    @Lob protected PdbxPhasingMADSetShellType pdbxPhasingMADSetShellCategory;
    @XmlElement(name = "pdbx_phasing_MAD_set_siteCategory")
    @Lob protected PdbxPhasingMADSetSiteType pdbxPhasingMADSetSiteCategory;
    @XmlElement(name = "pdbx_phasing_MAD_shellCategory")
    @Lob protected PdbxPhasingMADShellType pdbxPhasingMADShellCategory;
    @XmlElement(name = "pdbx_phasing_MRCategory")
    @Lob protected PdbxPhasingMRType pdbxPhasingMRCategory;
    @XmlElement(name = "pdbx_phasing_dmCategory")
    @Lob protected PdbxPhasingDmType pdbxPhasingDmCategory;
    @XmlElement(name = "pdbx_phasing_dm_shellCategory")
    @Lob protected PdbxPhasingDmShellType pdbxPhasingDmShellCategory;
    @XmlElement(name = "pdbx_point_symmetryCategory")
    @Lob protected PdbxPointSymmetryType pdbxPointSymmetryCategory;
    @XmlElement(name = "pdbx_poly_seq_schemeCategory")
    @Lob protected PdbxPolySeqSchemeType pdbxPolySeqSchemeCategory;
    @XmlElement(name = "pdbx_prd_auditCategory")
    @Lob protected PdbxPrdAuditType pdbxPrdAuditCategory;
    @XmlElement(name = "pdbx_prerelease_seqCategory")
    @Lob protected PdbxPrereleaseSeqType pdbxPrereleaseSeqCategory;
    @XmlElement(name = "pdbx_re_refinementCategory")
    @Lob protected PdbxReRefinementType pdbxReRefinementCategory;
    @XmlElement(name = "pdbx_reference_entity_linkCategory")
    @Lob protected PdbxReferenceEntityLinkType pdbxReferenceEntityLinkCategory;
    @XmlElement(name = "pdbx_reference_entity_listCategory")
    @Lob protected PdbxReferenceEntityListType pdbxReferenceEntityListCategory;
    @XmlElement(name = "pdbx_reference_entity_nonpolyCategory")
    @Lob protected PdbxReferenceEntityNonpolyType pdbxReferenceEntityNonpolyCategory;
    @XmlElement(name = "pdbx_reference_entity_polyCategory")
    @Lob protected PdbxReferenceEntityPolyType pdbxReferenceEntityPolyCategory;
    @XmlElement(name = "pdbx_reference_entity_poly_linkCategory")
    @Lob protected PdbxReferenceEntityPolyLinkType pdbxReferenceEntityPolyLinkCategory;
    @XmlElement(name = "pdbx_reference_entity_poly_seqCategory")
    @Lob protected PdbxReferenceEntityPolySeqType pdbxReferenceEntityPolySeqCategory;
    @XmlElement(name = "pdbx_reference_entity_sequenceCategory")
    @Lob protected PdbxReferenceEntitySequenceType pdbxReferenceEntitySequenceCategory;
    @XmlElement(name = "pdbx_reference_entity_src_natCategory")
    @Lob protected PdbxReferenceEntitySrcNatType pdbxReferenceEntitySrcNatCategory;
    @XmlElement(name = "pdbx_reference_entity_subcomponentsCategory")
    @Lob protected PdbxReferenceEntitySubcomponentsType pdbxReferenceEntitySubcomponentsCategory;
    @XmlElement(name = "pdbx_reference_moleculeCategory")
    @Lob protected PdbxReferenceMoleculeType pdbxReferenceMoleculeCategory;
    @XmlElement(name = "pdbx_reference_molecule_annotationCategory")
    @Lob protected PdbxReferenceMoleculeAnnotationType pdbxReferenceMoleculeAnnotationCategory;
    @XmlElement(name = "pdbx_reference_molecule_detailsCategory")
    @Lob protected PdbxReferenceMoleculeDetailsType pdbxReferenceMoleculeDetailsCategory;
    @XmlElement(name = "pdbx_reference_molecule_familyCategory")
    @Lob protected PdbxReferenceMoleculeFamilyType pdbxReferenceMoleculeFamilyCategory;
    @XmlElement(name = "pdbx_reference_molecule_featuresCategory")
    @Lob protected PdbxReferenceMoleculeFeaturesType pdbxReferenceMoleculeFeaturesCategory;
    @XmlElement(name = "pdbx_reference_molecule_listCategory")
    @Lob protected PdbxReferenceMoleculeListType pdbxReferenceMoleculeListCategory;
    @XmlElement(name = "pdbx_reference_molecule_related_structuresCategory")
    @Lob protected PdbxReferenceMoleculeRelatedStructuresType pdbxReferenceMoleculeRelatedStructuresCategory;
    @XmlElement(name = "pdbx_reference_molecule_synonymsCategory")
    @Lob protected PdbxReferenceMoleculeSynonymsType pdbxReferenceMoleculeSynonymsCategory;
    @XmlElement(name = "pdbx_reference_publication_listCategory")
    @Lob protected PdbxReferencePublicationListType pdbxReferencePublicationListCategory;
    @XmlElement(name = "pdbx_refineCategory")
    @Lob protected PdbxRefineType pdbxRefineCategory;
    @XmlElement(name = "pdbx_refine_aux_fileCategory")
    @Lob protected PdbxRefineAuxFileType pdbxRefineAuxFileCategory;
    @XmlElement(name = "pdbx_refine_componentCategory")
    @Lob protected PdbxRefineComponentType pdbxRefineComponentCategory;
    @XmlElement(name = "pdbx_refine_tlsCategory")
    @Lob protected PdbxRefineTlsType pdbxRefineTlsCategory;
    @XmlElement(name = "pdbx_refine_tls_groupCategory")
    @Lob protected PdbxRefineTlsGroupType pdbxRefineTlsGroupCategory;
    @XmlElement(name = "pdbx_reflns_twinCategory")
    @Lob protected PdbxReflnsTwinType pdbxReflnsTwinCategory;
    @XmlElement(name = "pdbx_related_exp_data_setCategory")
    @Lob protected PdbxRelatedExpDataSetType pdbxRelatedExpDataSetCategory;
    @XmlElement(name = "pdbx_remediation_atom_site_mappingCategory")
    @Lob protected PdbxRemediationAtomSiteMappingType pdbxRemediationAtomSiteMappingCategory;
    @XmlElement(name = "pdbx_robot_systemCategory")
    @Lob protected PdbxRobotSystemType pdbxRobotSystemCategory;
    @XmlElement(name = "pdbx_sequence_rangeCategory")
    @Lob protected PdbxSequenceRangeType pdbxSequenceRangeCategory;
    @XmlElement(name = "pdbx_soln_scatterCategory")
    @Lob protected PdbxSolnScatterType pdbxSolnScatterCategory;
    @XmlElement(name = "pdbx_soln_scatter_modelCategory")
    @Lob protected PdbxSolnScatterModelType pdbxSolnScatterModelCategory;
    @XmlElement(name = "pdbx_struct_assemblyCategory")
    @Lob protected PdbxStructAssemblyType pdbxStructAssemblyCategory;
    @XmlElement(name = "pdbx_struct_assembly_genCategory")
    @Lob protected PdbxStructAssemblyGenType pdbxStructAssemblyGenCategory;
    @XmlElement(name = "pdbx_struct_assembly_propCategory")
    @Lob protected PdbxStructAssemblyPropType pdbxStructAssemblyPropCategory;
    @XmlElement(name = "pdbx_struct_asym_genCategory")
    @Lob protected PdbxStructAsymGenType pdbxStructAsymGenCategory;
    @XmlElement(name = "pdbx_struct_chem_comp_diagnosticsCategory")
    @Lob protected PdbxStructChemCompDiagnosticsType pdbxStructChemCompDiagnosticsCategory;
    @XmlElement(name = "pdbx_struct_chem_comp_featureCategory")
    @Lob protected PdbxStructChemCompFeatureType pdbxStructChemCompFeatureCategory;
    @XmlElement(name = "pdbx_struct_conn_angleCategory")
    @Lob protected PdbxStructConnAngleType pdbxStructConnAngleCategory;
    @XmlElement(name = "pdbx_struct_entity_instCategory")
    @Lob protected PdbxStructEntityInstType pdbxStructEntityInstCategory;
    @XmlElement(name = "pdbx_struct_group_component_rangeCategory")
    @Lob protected PdbxStructGroupComponentRangeType pdbxStructGroupComponentRangeCategory;
    @XmlElement(name = "pdbx_struct_group_componentsCategory")
    @Lob protected PdbxStructGroupComponentsType pdbxStructGroupComponentsCategory;
    @XmlElement(name = "pdbx_struct_group_listCategory")
    @Lob protected PdbxStructGroupListType pdbxStructGroupListCategory;
    @XmlElement(name = "pdbx_struct_infoCategory")
    @Lob protected PdbxStructInfoType pdbxStructInfoCategory;
    @XmlElement(name = "pdbx_struct_legacy_oper_listCategory")
    @Lob protected PdbxStructLegacyOperListType pdbxStructLegacyOperListCategory;
    @XmlElement(name = "pdbx_struct_mod_residueCategory")
    @Lob protected PdbxStructModResidueType pdbxStructModResidueCategory;
    @XmlElement(name = "pdbx_struct_msym_genCategory")
    @Lob protected PdbxStructMsymGenType pdbxStructMsymGenCategory;
    @XmlElement(name = "pdbx_struct_oper_listCategory")
    @Lob protected PdbxStructOperListType pdbxStructOperListCategory;
    @XmlElement(name = "pdbx_struct_ref_seq_deletionCategory")
    @Lob protected PdbxStructRefSeqDeletionType pdbxStructRefSeqDeletionCategory;
    @XmlElement(name = "pdbx_struct_ref_seq_featureCategory")
    @Lob protected PdbxStructRefSeqFeatureType pdbxStructRefSeqFeatureCategory;
    @XmlElement(name = "pdbx_struct_ref_seq_feature_propCategory")
    @Lob protected PdbxStructRefSeqFeaturePropType pdbxStructRefSeqFeaturePropCategory;
    @XmlElement(name = "pdbx_struct_ref_seq_insertionCategory")
    @Lob protected PdbxStructRefSeqInsertionType pdbxStructRefSeqInsertionCategory;
    @XmlElement(name = "pdbx_struct_sheet_hbondCategory")
    @Lob protected PdbxStructSheetHbondType pdbxStructSheetHbondCategory;
    @XmlElement(name = "pdbx_struct_special_symmetryCategory")
    @Lob protected PdbxStructSpecialSymmetryType pdbxStructSpecialSymmetryCategory;
    @XmlElement(name = "pdbx_unobs_or_zero_occ_atomsCategory")
    @Lob protected PdbxUnobsOrZeroOccAtomsType pdbxUnobsOrZeroOccAtomsCategory;
    @XmlElement(name = "pdbx_unobs_or_zero_occ_residuesCategory")
    @Lob protected PdbxUnobsOrZeroOccResiduesType pdbxUnobsOrZeroOccResiduesCategory;
    @XmlElement(name = "pdbx_validate_chiralCategory")
    @Lob protected PdbxValidateChiralType pdbxValidateChiralCategory;
    @XmlElement(name = "pdbx_validate_close_contactCategory")
    @Lob protected PdbxValidateCloseContactType pdbxValidateCloseContactCategory;
    @XmlElement(name = "pdbx_validate_main_chain_planeCategory")
    @Lob protected PdbxValidateMainChainPlaneType pdbxValidateMainChainPlaneCategory;
    @XmlElement(name = "pdbx_validate_peptide_omegaCategory")
    @Lob protected PdbxValidatePeptideOmegaType pdbxValidatePeptideOmegaCategory;
    @XmlElement(name = "pdbx_validate_planesCategory")
    @Lob protected PdbxValidatePlanesType pdbxValidatePlanesCategory;
    @XmlElement(name = "pdbx_validate_planes_atomCategory")
    @Lob protected PdbxValidatePlanesAtomType pdbxValidatePlanesAtomCategory;
    @XmlElement(name = "pdbx_validate_polymer_linkageCategory")
    @Lob protected PdbxValidatePolymerLinkageType pdbxValidatePolymerLinkageCategory;
    @XmlElement(name = "pdbx_validate_rmsd_angleCategory")
    @Lob protected PdbxValidateRmsdAngleType pdbxValidateRmsdAngleCategory;
    @XmlElement(name = "pdbx_validate_rmsd_bondCategory")
    @Lob protected PdbxValidateRmsdBondType pdbxValidateRmsdBondCategory;
    @XmlElement(name = "pdbx_validate_symm_contactCategory")
    @Lob protected PdbxValidateSymmContactType pdbxValidateSymmContactCategory;
    @XmlElement(name = "pdbx_validate_torsionCategory")
    @Lob protected PdbxValidateTorsionType pdbxValidateTorsionCategory;
    @XmlElement(name = "pdbx_versionCategory")
    @Lob protected PdbxVersionType pdbxVersionCategory;
    @XmlElement(name = "pdbx_xplor_fileCategory")
    @Lob protected PdbxXplorFileType pdbxXplorFileCategory;
    @Lob protected PhasingType phasingCategory;
    @XmlElement(name = "phasing_MADCategory")
    @Lob protected PhasingMADType phasingMADCategory;
    @XmlElement(name = "phasing_MAD_clustCategory")
    @Lob protected PhasingMADClustType phasingMADClustCategory;
    @XmlElement(name = "phasing_MAD_exptCategory")
    @Lob protected PhasingMADExptType phasingMADExptCategory;
    @XmlElement(name = "phasing_MAD_ratioCategory")
    @Lob protected PhasingMADRatioType phasingMADRatioCategory;
    @XmlElement(name = "phasing_MAD_setCategory")
    @Lob protected PhasingMADSetType phasingMADSetCategory;
    @XmlElement(name = "phasing_MIRCategory")
    @Lob protected PhasingMIRType phasingMIRCategory;
    @XmlElement(name = "phasing_MIR_derCategory")
    @Lob protected PhasingMIRDerType phasingMIRDerCategory;
    @XmlElement(name = "phasing_MIR_der_reflnCategory")
    @Lob protected PhasingMIRDerReflnType phasingMIRDerReflnCategory;
    @XmlElement(name = "phasing_MIR_der_shellCategory")
    @Lob protected PhasingMIRDerShellType phasingMIRDerShellCategory;
    @XmlElement(name = "phasing_MIR_der_siteCategory")
    @Lob protected PhasingMIRDerSiteType phasingMIRDerSiteCategory;
    @XmlElement(name = "phasing_MIR_shellCategory")
    @Lob protected PhasingMIRShellType phasingMIRShellCategory;
    @XmlElement(name = "phasing_averagingCategory")
    @Lob protected PhasingAveragingType phasingAveragingCategory;
    @XmlElement(name = "phasing_isomorphousCategory")
    @Lob protected PhasingIsomorphousType phasingIsomorphousCategory;
    @XmlElement(name = "phasing_setCategory")
    @Lob protected PhasingSetType phasingSetCategory;
    @XmlElement(name = "phasing_set_reflnCategory")
    @Lob protected PhasingSetReflnType phasingSetReflnCategory;
    @Lob protected PublType publCategory;
    @XmlElement(name = "publ_authorCategory")
    @Lob protected PublAuthorType publAuthorCategory;
    @XmlElement(name = "publ_bodyCategory")
    @Lob protected PublBodyType publBodyCategory;
    @XmlElement(name = "publ_manuscript_inclCategory")
    @Lob protected PublManuscriptInclType publManuscriptInclCategory;
    @Lob protected RefineType refineCategory;
    @XmlElement(name = "refine_B_isoCategory")
    @Lob protected RefineBIsoType refineBIsoCategory;
    @XmlElement(name = "refine_analyzeCategory")
    @Lob protected RefineAnalyzeType refineAnalyzeCategory;
    @XmlElement(name = "refine_funct_minimizedCategory")
    @Lob protected RefineFunctMinimizedType refineFunctMinimizedCategory;
    @XmlElement(name = "refine_histCategory")
    @Lob protected RefineHistType refineHistCategory;
    @XmlElement(name = "refine_ls_classCategory")
    @Lob protected RefineLsClassType refineLsClassCategory;
    @XmlElement(name = "refine_ls_restrCategory")
    @Lob protected RefineLsRestrType refineLsRestrCategory;
    @XmlElement(name = "refine_ls_restr_ncsCategory")
    @Lob protected RefineLsRestrNcsType refineLsRestrNcsCategory;
    @XmlElement(name = "refine_ls_restr_typeCategory")
    @Lob protected RefineLsRestrTypeType refineLsRestrTypeCategory;
    @XmlElement(name = "refine_ls_shellCategory")
    @Lob protected RefineLsShellType refineLsShellCategory;
    @XmlElement(name = "refine_occupancyCategory")
    @Lob protected RefineOccupancyType refineOccupancyCategory;
    @Lob protected ReflnType reflnCategory;
    @XmlElement(name = "refln_sys_absCategory")
    @Lob protected ReflnSysAbsType reflnSysAbsCategory;
    @Lob protected ReflnsType reflnsCategory;
    @XmlElement(name = "reflns_classCategory")
    @Lob protected ReflnsClassType reflnsClassCategory;
    @XmlElement(name = "reflns_scaleCategory")
    @Lob protected ReflnsScaleType reflnsScaleCategory;
    @XmlElement(name = "reflns_shellCategory")
    @Lob protected ReflnsShellType reflnsShellCategory;
    @Lob protected SoftwareType softwareCategory;
    @XmlElement(name = "space_groupCategory")
    @Lob protected SpaceGroupType spaceGroupCategory;
    @XmlElement(name = "space_group_symopCategory")
    @Lob protected SpaceGroupSymopType spaceGroupSymopCategory;
    @Lob protected StructType structCategory;
    @XmlElement(name = "struct_asymCategory")
    @Lob protected StructAsymType structAsymCategory;
    @XmlElement(name = "struct_biolCategory")
    @Lob protected StructBiolType structBiolCategory;
    @XmlElement(name = "struct_biol_genCategory")
    @Lob protected StructBiolGenType structBiolGenCategory;
    @XmlElement(name = "struct_biol_keywordsCategory")
    @Lob protected StructBiolKeywordsType structBiolKeywordsCategory;
    @XmlElement(name = "struct_biol_viewCategory")
    @Lob protected StructBiolViewType structBiolViewCategory;
    @XmlElement(name = "struct_confCategory")
    @Lob protected StructConfType structConfCategory;
    @XmlElement(name = "struct_conf_typeCategory")
    @Lob protected StructConfTypeType structConfTypeCategory;
    @XmlElement(name = "struct_connCategory")
    @Lob protected StructConnType structConnCategory;
    @XmlElement(name = "struct_conn_typeCategory")
    @Lob protected StructConnTypeType structConnTypeCategory;
    @XmlElement(name = "struct_keywordsCategory")
    @Lob protected StructKeywordsType structKeywordsCategory;
    @XmlElement(name = "struct_mon_detailsCategory")
    @Lob protected StructMonDetailsType structMonDetailsCategory;
    @XmlElement(name = "struct_mon_nuclCategory")
    @Lob protected StructMonNuclType structMonNuclCategory;
    @XmlElement(name = "struct_mon_protCategory")
    @Lob protected StructMonProtType structMonProtCategory;
    @XmlElement(name = "struct_mon_prot_cisCategory")
    @Lob protected StructMonProtCisType structMonProtCisCategory;
    @XmlElement(name = "struct_ncs_domCategory")
    @Lob protected StructNcsDomType structNcsDomCategory;
    @XmlElement(name = "struct_ncs_dom_limCategory")
    @Lob protected StructNcsDomLimType structNcsDomLimCategory;
    @XmlElement(name = "struct_ncs_ensCategory")
    @Lob protected StructNcsEnsType structNcsEnsCategory;
    @XmlElement(name = "struct_ncs_ens_genCategory")
    @Lob protected StructNcsEnsGenType structNcsEnsGenCategory;
    @XmlElement(name = "struct_ncs_operCategory")
    @Lob protected StructNcsOperType structNcsOperCategory;
    @XmlElement(name = "struct_refCategory")
    @Lob protected StructRefType structRefCategory;
    @XmlElement(name = "struct_ref_seqCategory")
    @Lob protected StructRefSeqType structRefSeqCategory;
    @XmlElement(name = "struct_ref_seq_difCategory")
    @Lob protected StructRefSeqDifType structRefSeqDifCategory;
    @XmlElement(name = "struct_sheetCategory")
    @Lob protected StructSheetType structSheetCategory;
    @XmlElement(name = "struct_sheet_hbondCategory")
    @Lob protected StructSheetHbondType structSheetHbondCategory;
    @XmlElement(name = "struct_sheet_orderCategory")
    @Lob protected StructSheetOrderType structSheetOrderCategory;
    @XmlElement(name = "struct_sheet_rangeCategory")
    @Lob protected StructSheetRangeType structSheetRangeCategory;
    @XmlElement(name = "struct_sheet_topologyCategory")
    @Lob protected StructSheetTopologyType structSheetTopologyCategory;
    @XmlElement(name = "struct_siteCategory")
    @Lob protected StructSiteType structSiteCategory;
    @XmlElement(name = "struct_site_genCategory")
    @Lob protected StructSiteGenType structSiteGenCategory;
    @XmlElement(name = "struct_site_keywordsCategory")
    @Lob protected StructSiteKeywordsType structSiteKeywordsCategory;
    @XmlElement(name = "struct_site_viewCategory")
    @Lob protected StructSiteViewType structSiteViewCategory;
    @Lob protected SymmetryType symmetryCategory;
    @XmlElement(name = "symmetry_equivCategory")
    @Lob protected SymmetryEquivType symmetryEquivCategory;
    @XmlElement(name = "valence_paramCategory")
    @Lob protected ValenceParamType valenceParamCategory;
    @XmlElement(name = "valence_refCategory")
    @Lob protected ValenceRefType valenceRefCategory;
    @XmlAttribute(name = "datablockName")
    @Lob protected String datablockName;
