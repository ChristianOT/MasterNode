package forYoink.yoinkTranslator;

import forYoink.interfaces.IAtomSite;
import forYoink.interfaces.ICartn;
import forYoink.interfaces.IDatablockType;
import forYoink.yoinkClasses.SimpleCoordFactory;
...
public class MolecularSystemTranslator implements Translator<MolecularSystem, JAXBElement<IDatablockType>> {
    ...
    public MolecularSystem translate(JAXBElement<IDatablockType> item) {
        return new SimpleMolecularSystem(translateToMolecule(item.getValue()));
    }
