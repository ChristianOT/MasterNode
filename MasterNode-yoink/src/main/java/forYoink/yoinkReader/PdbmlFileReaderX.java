 ...
 */
//@Service
public class PdbmlFileReaderX implements ResourceAwareItemReaderItemStream<JAXBElement> {

    private Resource resource;

    private JAXBContext jaxbContext;

    public PdbmlFileReaderX() {
    }

    public PdbmlFileReaderX(JAXBContext jaxbContext) {
        this.jaxbContext = jaxbContext;
    }

    public PdbmlFileReaderX(Resource resource, JAXBContext jaxbContext) {
