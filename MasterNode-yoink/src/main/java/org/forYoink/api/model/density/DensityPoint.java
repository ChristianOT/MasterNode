 ...
 */
package org.forYoink.api.model.density;

import org.forYoink.api.model.molecular.Coord;
import org.forYoink.api.service.math.Matrix;
...
public interface DensityPoint {
	 ...
	 * 
	 * @return density value -{@link Double}
	 */
	double getDensity();
	 ...
	 *
	 * @param density
	 *            -{@link Double}, electronic density,
	 */
	 ...
	 *         {@link org.forYoink.api.service.math.Vector}
	 */
	 ...
	 *
	 * @return density gradient -{@link Double}
	 */
	double getGradient();
	 ...
	 * 
	 * @return current coordinate -{@link org.forYoink.api.model.molecular.Coord}
	 */
